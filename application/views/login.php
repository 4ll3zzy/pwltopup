	...
	<nav class="navbar navbar-expand-lg fixed-top navbar-light bg-custom shadow-sm p-3 mb-5 bg-white">
		<div class="container">
			<a class="navbar-brand" href="/">
				<img src="<?php echo base_url('assets/vendor/template') ?>/assets/images/svmmer.png" width="160px" />
			</a>
					...
					<div class="card-body">
						...
						<form method="POST" action="<?php echo site_url('login/autentikasi');?>">
							<div class="">
                                ...
                                <div class="w3-panel w3-blue w3-display-container"> <?php echo $this->session->flashdata('msg');?> </div>
							</div>
						</form>
					</div>
				</div>
